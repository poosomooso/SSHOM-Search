...
def get_smart_avg(path, start_time, end_time):
    run1 = get_sshom_times(path+bk.SMART1, end_time)
    run2 = get_sshom_times(path+bk.SMART2, end_time)
    run3 = get_sshom_times(path+bk.SMART3, end_time)
...
def triangle_get_smart_avg(path, start_time, end_time):
    run1 = get_sshom_times(path+bk.SMART1, end_time)
