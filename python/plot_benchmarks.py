...
plt.plot([ga.candidates_100k], [ga.avg_at_100k], marker='o', markersize=10, color="green", linewidth=lwidth, label="100k Genetic Algorithm Candidates", linestyle = 'None')
...
plt.savefig('/home/serena/reuse/paper_figs/legend2.pdf', format='pdf', dpi=400)
# plt.show()
